...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <span className="icon-[tabler--chevron-right] ml-auto" />
    </MenuPrimitive.SubmenuTrigger>
  );
}
...
function DropdownMenuSeparator({ className, ...props }: MenuPrimitive.Separator.Props) {
  return (
    <MenuPrimitive.Separator className={cn("-mx-1 my-1 h-px bg-border/50", className)} data-slot="dropdown-menu-separator" {...props} />
  );
}
