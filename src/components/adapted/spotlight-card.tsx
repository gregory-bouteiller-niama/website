...
// MAIN ------------------------------------------------------------------------------------------------------------------------------------
export function SpotlightCard({ children, className = "", color = "rgba(255, 255, 255, 0.25)" }: SpotlightCardProps) {
  ...
  return (
    <Card
      className={cn(SPOTLIGHT_CARD.base(), className)}
      onBlur={handleBlur}
      onFocus={handleFocus}
    ...
    >
      <div
        className={SPOTLIGHT_CARD.light()}
        style={{
          opacity,
...
type SpotlightCardProps = ItemProps & { color?: `rgba(${number}, ${number}, ${number}, ${number})` };
